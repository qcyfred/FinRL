...
class SignalTradingEnv(gym.Env):
    ...
    def _calculate_reward(self, prev_value, current_value):
        ...
        # 简单的收益率奖励
        reward_coefficient = self.reward_config.get('return_weight', 1.0)
    ...
    def _calculate_final_reward(self):
        ...
        # 最终奖励系数
        final_coefficient = self.reward_config.get('final_reward_weight', 2.0)
        final_reward = final_coefficient * total_return
